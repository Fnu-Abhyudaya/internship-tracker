...
def get_all_scrapers() -> List[BaseScraper]:
    ...
    # ===== SAP SUCCESSFACTORS =====
    # These sites all use SF backend; dedicated scraper
    # handles sort by date + pagination properly.
    successfactors_configs = [
        {'company': 'AMETEK',
         'url': 'https://jobs.ametek.com/search/'},
        {'company': 'BD',
         'url': 'https://jobs.bd.com/en/search-jobs/'},
        {'company': 'Tenneco',
         'url': 'https://jobs.tenneco.com/search/'},
        {'company': 'Danfoss',
         'url': 'https://jobs.danfoss.com/search/'},
        {'company': 'ASSA ABLOY',
         'url': 'https://assaabloy.jobs2web.com/search/'},
        {'company': 'Schaeffler',
         'url': 'https://jobs.schaeffler.com/search/'},
        {'company': 'ATS Automation',
         'url': 'https://jobs.atsautomation.com/search/'},
        {'company': 'Fresenius Medical Care',
         'url': 'https://jobs.freseniusmedicalcare.com/search/'},
        {'company': 'Sloan Valve',
         'url': 'https://jobs.sloan.com/search/'},
        {'company': 'Dana Inc',
         'url': 'https://jobs.dana.com/search/'},
        {'company': 'AECOM',
         'url': 'https://aecom.jobs/search/'},
    ]
    for cfg in successfactors_configs:
